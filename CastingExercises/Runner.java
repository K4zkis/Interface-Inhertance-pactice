...
public class Runner {
	...
	public static void main(String[] args) {
		...
		*/
		...
		somewhat repeated in the exercise below
		---------------------------------

		 */
		ArrayList<FoodItem> lowCalorieFoods = counter1.getAllLowCalorieFoods();
		for (FoodItem food:lowCalorieFoods)
		{
			if (food.getClass().equals(ReadyMeal.class))
			{
				ReadyMeal downCastFood = (ReadyMeal) food;
				System.out.println("name: "+downCastFood.getName()+" price: "+downCastFood.getPrice()+
						" cuisine: "+downCastFood.getCuisineType()); 
			}
			else if (food.getClass().equals(Snack.class))
			{
				Snack downCastFood = (Snack) food;
				System.out.println("name: "+downCastFood.getName()+" price: "+downCastFood.getPrice()+
						" Fat Content: "+downCastFood.getFatContent());
			}
			else System.out.println("we neither snack nor readymeal");
		}
		...
		counter1.removeHighCalorieFoodsFromBasket(basket1, 500);
		System.out.println("-------------------------------");
		for (BasketItem item:basket1.getAllItems())
		{
